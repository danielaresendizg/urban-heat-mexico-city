...
<qgis version="3.34.12-Prizren" minScale="1e+08" autoRefreshMode="Disabled" maxScale="0" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories">
  ...
  <elevation zoffset="0" band="1" zscale="1" enabled="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" force_rhr="0" type="line" alpha="1" is_animated="0" name="" frame_rate="10">
        ...
        <layer class="SimpleLine" locked="0" pass="0" enabled="1" id="{b18edbd9-9002-4c49-86ce-49b421abfda3}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" force_rhr="0" type="fill" alpha="1" is_animated="0" name="" frame_rate="10">
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1" id="{91e01c15-e758-4771-9063-7f5d675c4000}">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" classificationMax="1" type="singlebandpseudocolor" opacity="1" alphaBand="-1" nodataColor="" classificationMin="-0.32">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" classificationMode="1" maximumValue="1" labelPrecision="4" clip="0" minimumValue="-0.32000000000000001">
          <colorramp type="gradient" name="[source]">
            <Option type="Map">
              <Option value="0,0,160,255" type="QString" name="color1"/>
              <Option value="0,128,0,255" type="QString" name="color2"/>
              <Option value="ccw" type="QString" name="direction"/>
              <Option value="0" type="QString" name="discrete"/>
              <Option value="gradient" type="QString" name="rampType"/>
              <Option value="rgb" type="QString" name="spec"/>
              <Option value="0.455529;255,255,255,255;rgb;ccw" type="QString" name="stops"/>
            </Option>
          </colorramp>
          <item color="#0000a0" value="-0.32" alpha="255" label="-0.3200"/>
          <item color="#ffffff" value="0.281298076923077" alpha="255" label="0.2813"/>
          <item color="#008000" value="1" alpha="255" label="1.0000"/>
